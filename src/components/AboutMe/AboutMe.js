      ...
      <div className="about-me__container">
        <div className="about-me__content">
          ...
          <p className="about-me__text">
            ...
            факультет ННГУ им.Лобачевского. Благодаря курсу Веб-разработчик в
            Яндекс Практикуме, убедилась, что мне интересна разработка и я могу
            создавать не только дизайн. Хочу развиваться в этом направлении,
            постоянно расширяя и углубляя свои знания.
          </p>
          <a
